...
namespace Recurly.Resources
{
    ...
    public class SubscriptionShippingCreate : Request
    {
        ...
        /// <value>Create a shipping address on the account and assign it to the subscription. If `address_id` and `address` are both present, `address` will be used.</value>
